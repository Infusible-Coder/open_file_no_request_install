...
import 'package:open_file_no_request_install/src/common/open_result.dart';
...
class OpenFile {
  static const MethodChannel _channel =
      const MethodChannel('open_file_no_request_install');
  ...
  static Future<OpenResult> open(String? filePath,
    ...
    final _result =
        await _channel.invokeMethod('open_file_no_request_install', map);
