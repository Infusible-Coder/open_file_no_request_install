...
[![pub package](https://img.shields.io/pub/v/open_file_no_request_install.svg)](https://pub.dartlang.org/packages/open_file_no_request_install)
...
To use this plugin, add [open_file_no_request_install](https://pub.dartlang.org/packages/open_file_no_request_install#-installing-tab-) as a dependency in your pubspec.yaml file.
```yaml
dependencies:
  #androidx
  open_file_no_request_install: ^lastVersion 
  #support
  #open_file_no_request_install: ^1.3.0
```
